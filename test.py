...
button = ctk.Button(window, text="Testo Bottone", command=funzione_chiamata)
...
# Definizione del bottone
button2 = ctk.Button(window, text="Testo", command=funzione_chiamata)
# Inserisco il bottone nella griglia con padding 20 in entrambi gli assi
button2.grid(row=0, column=1, padx=20, pady=20)

# Definizione del bottone
button3 = ctk.Button(window, text="Testone", command=funzione_chiamata)
# Inserisco il bottone nella griglia con padding 20 in entrambi gli assi
# Dando l'attributo 'sticky="ew"' (che significa east e west) faccio in modo che prenda tutto lo spazio orizzontale disponibile
...
checkbox_1 = ctk.Checkbutton(window, text="checkbox 1")
...
# Definizione della checkbox
checkbox_2 = ctk.Checkbutton(window, text="checkbox 2")
